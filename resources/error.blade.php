...
<header class="topbar">
    ...
    <div class="topbar-actions">
        <div class="ai-button-group">
            ...
            <button type="button" class="ai-provider-btn ai-provider" data-provider="claude" aria-label="Ask Claude about this error">
                <svg viewBox="0 0 24 24" fill="currentColor">
            ...
            <button type="button" class="ai-provider-btn ai-provider" data-provider="perplexity" aria-label="Ask Perplexity about this error">
                <svg viewBox="0 0 24 24" fill="currentColor">
